...
export const TARI = {
  ...
  moldoveneasca: {
    ...
    culoare: '#1a3a1a',
    preparate: [
      { nume: 'Pelmeni', descriere: 'Găluște rusești cu carne de porc și vită, servite cu smântână și unt topit', pret: 68, este_desert: false, imagine: '/images/meniu-lunii/pelemni.jpg' },
      { nume: 'Hrișcă cu Sos Alb', descriere: 'Hrișcă fiartă servită cu sos cremos de smântână, ceapă și ciuperci de pădure', pret: 55, este_desert: false, imagine: '/images/meniu-lunii/hrisca.jpg' },
      { nume: 'Chiftele Moldovenești', descriere: 'Chiftele din carne tocată de porc cu usturoi și ierburi, la cuptor cu sos de roșii', pret: 72, este_desert: false, imagine: '/images/meniu-lunii/chiftele.jpg' },
      { nume: 'Salată de Crabi', descriere: 'Salată răcoritoare cu bețe de crab, porumb, ouă fierte și maioneză', pret: 48, este_desert: false, imagine: '/images/meniu-lunii/salataCrabi.jpg' },
      { nume: 'Siliotka pod Shuboi', descriere: 'Hering sub haină de blană — straturi de sfeclă, cartofi, morcov, ceapă și maioneză', pret: 58, este_desert: false, imagine: '/images/meniu-lunii/siliotka.jpg' },
      { nume: 'Zeamă Moldovenească', descriere: 'Supă tradițională de pui cu tăiței de casă, leuștean proaspăt și smântână', pret: 52, este_desert: false, imagine: '/images/meniu-lunii/zeama.jpg' },
      { nume: 'Tort Napoleon', descriere: 'Tort cu foi fragede și cremă de lapte — prezent la orice masă de sărbătoare', pret: 44, este_desert: true, imagine: '/images/meniu-lunii/napoleon.jpg' },
      { nume: 'Mule Moldovenești', descriere: 'Coșulețe fragede din aluat fraged umplute cu gem de caise sau vișine', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/mule.jpg' },
      { nume: 'Brânzoaice cu Smântână', descriere: 'Plăcinte cu brânză dulce de vaci, stafide și vanilie, servite cu smântână', pret: 40, este_desert: true, imagine: '/images/meniu-lunii/branzoaice.jpg' },
      { nume: 'Cușma lui Guguță', descriere: 'Tort răcoritor din blaturi de cacao cu cremă de frișcă și vișine — emblema copilăriei moldovenești', pret: 46, este_desert: true, imagine: '/images/meniu-lunii/cusma.jpg' },
      { nume: 'Medovik', descriere: 'Tort cu foi de miere și cremă de smântână — dulceața nostalgiei din est', pret: 42, este_desert: true, imagine: '/images/meniu-lunii/medovik.jpg' },
    ]
  },
  japoneza: {
    ...
    culoare: '#2a1a1a',
    preparate: [
      { nume: 'Wagyu Teppanyaki', descriere: 'Vită Wagyu A5 gătită pe plită de fontă cu sos ponzu și wasabi proaspăt', pret: 245, este_desert: false, imagine: '/images/meniu-lunii/Wagyu_Teppanyaki.jpg' },
      { nume: 'Miso Black Cod', descriere: 'Cod negru marinat 3 zile în miso alb și sake, caramelizat la grătar', pret: 165, este_desert: false, imagine: '/images/meniu-lunii/Miso.jpg' },
      { nume: 'Ramen Tonkotsu', descriere: 'Supă de oase de porc gătită 18 ore cu chashu, ou marinat și nori', pret: 88, este_desert: false, imagine: '/images/meniu-lunii/ramen.jpg' },
      { nume: 'Tempura Kaiseki', descriere: 'Selecție de legume și creveți în aluat tempura ușor, cu dashi dipping', pret: 95, este_desert: false, imagine: '/images/meniu-lunii/tempura.jpg' },
      { nume: 'Duck Teriyaki', descriere: 'Piept de rață glazurat în sos teriyaki cu orez sushi și salată de castraveți', pret: 115, este_desert: false, imagine: '/images/meniu-lunii/duck.jpg' },
      { nume: 'Mochi Ice Cream', descriere: 'Bile de orez glutinos umplute cu înghețată de matcha, mango și căpșuni', pret: 48, este_desert: true, imagine: '/images/meniu-lunii/mochi.jpg' },
      { nume: 'Dorayaki', descriere: 'Clătite japoneze cu umplutură de anko — pastă de fasole roșie dulce', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/Dorayaki.jpg' },
      { nume: 'Matcha Tiramisu', descriere: 'Reinterpretare japoneză a tiramisù cu matcha ceremonial și mascarpone', pret: 52, este_desert: true, imagine: '/images/meniu-lunii/matcha.jpg' },
      { nume: 'Taiyaki', descriere: 'Vafe în formă de pește umplute cu cremă de vanilie și pastă de matcha', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/Taiyaki.jpg' },
      { nume: 'Warabi Mochi', descriere: 'Jeleuri de bracken cu kinako și sirop de kuromitsu', pret: 42, este_desert: true, imagine: '/images/meniu-lunii/warabi.jpg' },
    ]
  },
  norvegiana: {
    ...
    culoare: '#0d1a2a',
    preparate: [
      { nume: 'Gravlaks', descriere: 'Somon curat în sare, zahăr și mărar, servit cu sos de muștar dulce', pret: 95, este_desert: false, imagine: '/images/meniu-lunii/Gravlaks.jpg' },
      { nume: 'Fårikål', descriere: 'Tocană națională norvegiană de miel cu varză albă și boabe de piper negru', pret: 88, este_desert: false, imagine: '/images/meniu-lunii/farikal.jpg' },
      { nume: 'Lutefisk', descriere: 'Cod uscat rehidratat tradițional, servit cu unt topit, mazăre și bacon', pret: 92, este_desert: false, imagine: '/images/meniu-lunii/Lutefisk.jpg' },
      { nume: 'Raspeballer', descriere: 'Găluște de cartofi cu bacon afumat și unt brun — comfort food norvegian', pret: 72, este_desert: false, imagine: '/images/meniu-lunii/raspeballer.jpg' },
      { nume: 'Kjøttkaker', descriere: 'Chiftele norvegiene în sos brun cu unt și smântână, cu cartofi fierți', pret: 78, este_desert: false, imagine: '/images/meniu-lunii/Kjøttkaker.jpg' },
      { nume: 'Multekrem', descriere: 'Frișcă bătută cu mure arctice — desertul regal al Norvegiei', pret: 46, este_desert: true, imagine: '/images/meniu-lunii/Multekrem.jpg' },
      { nume: 'Skoleboller', descriere: 'Chifle cu cardamom umplute cu cremă de vanilie și glasate cu cocos', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/Skoleboller.jpg' },
      { nume: 'Krumkake', descriere: 'Vafe subțiri și crocante cu cardamom, rulate con, umplute cu frișcă', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/Krumkake.jpg' },
      { nume: 'Kvæfjordkake', descriere: 'Cel mai bun tort din lume — blat cu vanilie, bezea crocantă și cremă', pret: 48, este_desert: true, imagine: '/images/meniu-lunii/Kvæfjordkake.jpg' },
      { nume: 'Lefse cu Unt și Scorțișoară', descriere: 'Lipie norvegiană moale din cartofi cu unt, zahăr și scorțișoară', pret: 32, este_desert: true, imagine: '/images/meniu-lunii/Lefse.jpg' },
    ]
  }
}
