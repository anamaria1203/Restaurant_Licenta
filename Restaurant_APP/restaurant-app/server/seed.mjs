...
await db.PreparatLunar.bulkCreate([
  // SPANIOLĂ
  { tara: 'spaniola', nume: 'Paella Valenciana', descriere: 'Paella tradițională cu pui, iepure, fasole verde și șofran de La Mancha', pret: 85, este_desert: false, imagine: '/images/meniu-lunii/paella.jpg' },
  { tara: 'spaniola', nume: 'Gambas al Ajillo', descriere: 'Creveți tigru în ulei de măsline cu usturoi, chili și pătrunjel', pret: 78, este_desert: false, imagine: '/images/meniu-lunii/gambas.jpg' },
  { tara: 'spaniola', nume: 'Cochinillo Asado', descriere: 'Purcel de lapte fript la cuptor după rețeta din Segovia — crocant și suculent', pret: 115, este_desert: false, imagine: '/images/meniu-lunii/cochilo.jpg' },
  { tara: 'spaniola', nume: 'Bacalao a la Vizcaína', descriere: 'Cod desărat gătit în sos de ardei roșu cu ceapă și roșii', pret: 88, este_desert: false, imagine: '/images/meniu-lunii/bacalao.jpg' },
  { tara: 'spaniola', nume: 'Rabo de Toro', descriere: 'Coadă de taur brasată în vin Rioja cu legume și ierburi aromatice', pret: 92, este_desert: false, imagine: '/images/meniu-lunii/rabo.jpg' },
  { tara: 'spaniola', nume: 'Churros con Chocolate', descriere: 'Churros crocante prăjite cu ciocolată caldă de înmuiat', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/churos.jpg' },
  { tara: 'spaniola', nume: 'Crema Catalana', descriere: 'Varianta spaniolă a crème brûlée cu scorțișoară și coajă de portocală', pret: 42, este_desert: true, imagine: '/images/meniu-lunii/catalana.jpg' },
  { tara: 'spaniola', nume: 'Tarta de Santiago', descriere: 'Tort de migdale cu zahăr pudră și Crucea Sfântului Iacob', pret: 40, este_desert: true, imagine: '/images/meniu-lunii/santiago.jpg' },
  { tara: 'spaniola', nume: 'Arroz con Leche', descriere: 'Orez cu lapte gătit lent cu vanilie, scorțișoară și coajă de lămâie', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/aroz.jpg' },
  { tara: 'spaniola', nume: 'Tocino de Cielo', descriere: 'Desert din gălbenuș de ou și caramel — mătăsos și intens', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/tocino.jpg' },

  // TURCEASCĂ
  { tara: 'turceasca', nume: 'Lamb Kebab', descriere: 'Miel marinat cu condimente otomane, la grătar pe cărbuni, cu orez pilaf', pret: 88, este_desert: false, imagine: '/images/meniu-lunii/lamb-Kebab.jpg' },
  { tara: 'turceasca', nume: 'Manti', descriere: 'Găluște turcești umplute cu miel, cu iaurt cu usturoi și unt cu boia', pret: 72, este_desert: false, imagine: '/images/meniu-lunii/manti.jpg' },
  { tara: 'turceasca', nume: 'Hamsi Tava', descriere: 'Hamsii proaspete în mălai, prăjite crocant, cu salată de rucola și lămâie', pret: 65, este_desert: false, imagine: '/images/meniu-lunii/hamsiTava.jpg' },
  { tara: 'turceasca', nume: 'İskender Kebab', descriere: 'Kebab de vită pe pâine pita cu sos de roșii, unt topit și iaurt', pret: 85, este_desert: false, imagine: '/images/meniu-lunii/iskender.jpg' },
  { tara: 'turceasca', nume: 'Kuzu Tandir', descriere: 'Miel gătit 12 ore la foc mic până cade de pe os, cu legume otomane', pret: 105, este_desert: false, imagine: '/images/meniu-lunii/kuzu.jpg' },
  { tara: 'turceasca', nume: 'Baklava', descriere: 'Foi de patiserie cu nuci și fistic, îmbibate în sirop de miere și apă de trandafiri', pret: 42, este_desert: true, imagine: '/images/meniu-lunii/baklava.jpg' },
  { tara: 'turceasca', nume: 'Künefe', descriere: 'Desert cu brânză topită între straturi de kadaif, cu sirop și fistic', pret: 48, este_desert: true, imagine: '/images/meniu-lunii/kunefe.jpg' },
  { tara: 'turceasca', nume: 'Sütlaç', descriere: 'Orez cu lapte copt la cuptor cu caramel deasupra — reconfortant și cremos', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/Sütlaç.jpg' },
  { tara: 'turceasca', nume: 'Lokma', descriere: 'Gogoși mici prăjite îmbibate în sirop de miere, cu scorțișoară și nucă', pret: 34, este_desert: true, imagine: '/images/meniu-lunii/Lokma.jpg' },
  { tara: 'turceasca', nume: 'Kazandibi', descriere: 'Budincă de lapte caramelizată cu textură mătăsoasă și aromă de trandafir', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/Kazandibi.jpg' },

  // MOLDOVENEASCĂ
  { tara: 'moldoveneasca', nume: 'Pelmeni', descriere: 'Găluște rusești cu carne de porc și vită, servite cu smântână și unt topit', pret: 68, este_desert: false, imagine: '/images/meniu-lunii/pelemni.jpg' },
  { tara: 'moldoveneasca', nume: 'Hrișcă cu Sos Alb', descriere: 'Hrișcă fiartă servită cu sos cremos de smântână, ceapă și ciuperci de pădure', pret: 55, este_desert: false, imagine: '/images/meniu-lunii/hrisca.jpg' },
  { tara: 'moldoveneasca', nume: 'Chiftele Moldovenești', descriere: 'Chiftele din carne tocată de porc cu usturoi și ierburi, la cuptor cu sos de roșii', pret: 72, este_desert: false, imagine: '/images/meniu-lunii/chiftele.jpg' },
  { tara: 'moldoveneasca', nume: 'Salată de Crabi', descriere: 'Salată răcoritoare cu bețe de crab, porumb, ouă fierte și maioneză', pret: 48, este_desert: false, imagine: '/images/meniu-lunii/salataCrabi.jpg' },
  { tara: 'moldoveneasca', nume: 'Siliotka pod Shuboi', descriere: 'Hering sub haină de blană — straturi de sfeclă, cartofi, morcov, ceapă și maioneză', pret: 58, este_desert: false, imagine: '/images/meniu-lunii/siliotka.jpg' },
  { tara: 'moldoveneasca', nume: 'Zeamă Moldovenească', descriere: 'Supă tradițională de pui cu tăiței de casă, leuștean proaspăt și smântână', pret: 52, este_desert: false, imagine: '/images/meniu-lunii/zeama.jpg' },
  { tara: 'moldoveneasca', nume: 'Tort Napoleon', descriere: 'Tort cu foi fragede și cremă de lapte — prezent la orice masă de sărbătoare', pret: 44, este_desert: true, imagine: '/images/meniu-lunii/napoleon.jpg' },
  { tara: 'moldoveneasca', nume: 'Mule Moldovenești', descriere: 'Coșulețe fragede din aluat fraged umplute cu gem de caise sau vișine', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/mule.jpg' },
  { tara: 'moldoveneasca', nume: 'Brânzoaice cu Smântână', descriere: 'Plăcinte cu brânză dulce de vaci, stafide și vanilie, servite cu smântână', pret: 40, este_desert: true, imagine: '/images/meniu-lunii/branzoaice.jpg' },
  { tara: 'moldoveneasca', nume: 'Cușma lui Guguță', descriere: 'Tort răcoritor din blaturi de cacao cu cremă de frișcă și vișine', pret: 46, este_desert: true, imagine: '/images/meniu-lunii/cusma.jpg' },
  { tara: 'moldoveneasca', nume: 'Medovik', descriere: 'Tort cu foi de miere și cremă de smântână — dulceața nostalgiei din est', pret: 42, este_desert: true, imagine: '/images/meniu-lunii/medovik.jpg' },

  // JAPONEZĂ
  { tara: 'japoneza', nume: 'Wagyu Teppanyaki', descriere: 'Vită Wagyu A5 gătită pe plită de fontă cu sos ponzu și wasabi proaspăt', pret: 245, este_desert: false, imagine: '/images/meniu-lunii/Wagyu_Teppanyaki.jpg' },
  { tara: 'japoneza', nume: 'Miso Black Cod', descriere: 'Cod negru marinat 3 zile în miso alb și sake, caramelizat la grătar', pret: 165, este_desert: false, imagine: '/images/meniu-lunii/Miso.jpg' },
  { tara: 'japoneza', nume: 'Ramen Tonkotsu', descriere: 'Supă de oase de porc gătită 18 ore cu chashu, ou marinat și nori', pret: 88, este_desert: false, imagine: '/images/meniu-lunii/ramen.jpg' },
  { tara: 'japoneza', nume: 'Tempura Kaiseki', descriere: 'Selecție de legume și creveți în aluat tempura ușor, cu dashi dipping', pret: 95, este_desert: false, imagine: '/images/meniu-lunii/tempura.jpg' },
  { tara: 'japoneza', nume: 'Duck Teriyaki', descriere: 'Piept de rață glazurat în sos teriyaki cu orez sushi și salată de castraveți', pret: 115, este_desert: false, imagine: '/images/meniu-lunii/duck.jpg' },
  { tara: 'japoneza', nume: 'Mochi Ice Cream', descriere: 'Bile de orez glutinos umplute cu înghețată de matcha, mango și căpșuni', pret: 48, este_desert: true, imagine: '/images/meniu-lunii/mochi.jpg' },
  { tara: 'japoneza', nume: 'Dorayaki', descriere: 'Clătite japoneze cu umplutură de anko — pastă de fasole roșie dulce', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/Dorayaki.jpg' },
  { tara: 'japoneza', nume: 'Matcha Tiramisu', descriere: 'Reinterpretare japoneză a tiramisù cu matcha ceremonial și mascarpone', pret: 52, este_desert: true, imagine: '/images/meniu-lunii/matcha.jpg' },
  { tara: 'japoneza', nume: 'Taiyaki', descriere: 'Vafe în formă de pește umplute cu cremă de vanilie și pastă de matcha', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/Taiyaki.jpg' },
  { tara: 'japoneza', nume: 'Warabi Mochi', descriere: 'Jeleuri de bracken cu kinako și sirop de kuromitsu', pret: 42, este_desert: true, imagine: '/images/meniu-lunii/warabi.jpg' },

  // NORVEGIANĂ
  { tara: 'norvegiana', nume: 'Gravlaks', descriere: 'Somon curat în sare, zahăr și mărar, servit cu sos de muștar dulce', pret: 95, este_desert: false, imagine: '/images/meniu-lunii/Gravlaks.jpg' },
  { tara: 'norvegiana', nume: 'Fårikål', descriere: 'Tocană națională norvegiană de miel cu varză albă și boabe de piper negru', pret: 88, este_desert: false, imagine: '/images/meniu-lunii/farikal.jpg' },
  { tara: 'norvegiana', nume: 'Lutefisk', descriere: 'Cod uscat rehidratat tradițional, servit cu unt topit, mazăre și bacon', pret: 92, este_desert: false, imagine: '/images/meniu-lunii/Lutefisk.jpg' },
  { tara: 'norvegiana', nume: 'Raspeballer', descriere: 'Găluște de cartofi cu bacon afumat și unt brun — comfort food norvegian', pret: 72, este_desert: false, imagine: '/images/meniu-lunii/raspeballer.jpg' },
  { tara: 'norvegiana', nume: 'Kjøttkaker', descriere: 'Chiftele norvegiene în sos brun cu unt și smântână, cu cartofi fierți', pret: 78, este_desert: false, imagine: '/images/meniu-lunii/Kjøttkaker.jpg' },
  { tara: 'norvegiana', nume: 'Multekrem', descriere: 'Frișcă bătută cu mure arctice — desertul regal al Norvegiei', pret: 46, este_desert: true, imagine: '/images/meniu-lunii/Multekrem.jpg' },
  { tara: 'norvegiana', nume: 'Skoleboller', descriere: 'Chifle cu cardamom umplute cu cremă de vanilie și glasate cu cocos', pret: 38, este_desert: true, imagine: '/images/meniu-lunii/Skoleboller.jpg' },
  { tara: 'norvegiana', nume: 'Krumkake', descriere: 'Vafe subțiri și crocante cu cardamom, rulate con, umplute cu frișcă', pret: 36, este_desert: true, imagine: '/images/meniu-lunii/Krumkake.jpg' },
  { tara: 'norvegiana', nume: 'Kvæfjordkake', descriere: 'Cel mai bun tort din lume — blat cu vanilie, bezea crocantă și cremă', pret: 48, este_desert: true, imagine: '/images/meniu-lunii/Kvæfjordkake.jpg' },
  { tara: 'norvegiana', nume: 'Lefse cu Unt și Scorțișoară', descriere: 'Lipie norvegiană moale din cartofi cu unt, zahăr și scorțișoară', pret: 32, este_desert: true, imagine: '/images/meniu-lunii/Lefse.jpg' },
])

console.log('Seed lunar complet! 50 preparate lunare inserate.')
